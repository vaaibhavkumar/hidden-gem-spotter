"""
apply_step9.py -- makes the portfolio simulation's entry signal configurable,
and switches portfolio_backtest.py to trade STRONG BUY only (the first thing
being tried after the first real run came in at 2.9% trailing-5yr CAGR vs an
11.1% SPY baseline). Overwrites the same 3 files apply_step8.py created --
run from the repo root:

    python3 apply_step9.py
    python3 -m pytest -q      # expect 108 passed
